...
joinSound.SoundId = "rbxassetid://111618654196795" -- ID nhạc khi chạy mã
joinSound.Volume = 3
...
game.StarterGui:SetCore(
    ...
    {
        Title = "Tavorxt Hub",
        Text = "https://discord.gg/rJ45dYzAjX",
        Duration = 2000
    })
...
require(game.ReplicatedStorage:WaitForChild("Notification")).new(
            " <Color=Green>Welcome to Tavorxt Hub<Color=/> "
        ):Display()

require(game.ReplicatedStorage:WaitForChild("Notification")).new(
            " <Color=Yellow>https://discord.gg/rJ45dYzAjX<Color=/> "
        ):Display()
